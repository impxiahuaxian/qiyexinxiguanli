		       ...
		       text: "职位管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Position/position_add.jsp"
			    	   	},
			    		{
			    	   		text: "职位管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Position/position_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "员工管理",
		       ...
		       text: "任务管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Mission/mission_add.jsp"
			    	   	},
			    		{
			    	   		text: "任务管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Mission/mission_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "公告栏",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Employgg/employgg_add.jsp"
			    	   	},
			    		{
			    	   		text: "公告管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Employgg/employgg_query_result.jsp"
			    	    }
			    	   ]
			},{
			       text: "系统管理",
